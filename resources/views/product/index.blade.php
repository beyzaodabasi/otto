    ...
    <div class="">
      ...
      <div class="card-body">
        ...
        <thead>
          ...
          <th class="text-center">Ürün Detayı</th>
          </tr>
        </thead>
        <tfoot>
          <tr>
...
@section('customjs')
  ...
  <script>
    ...
    var table = $('#products').DataTable({
      ...
      ajax: "{{ route('products.data') }}", // AJAX ile veri çekme
      dom: 'Bfrtip', // Butonları eklemek için gerekli yapı
      buttons: ["excel", "pdf"], // Butonlar
      columns: [
      { data: 'created_at', name: 'created_at' },
      { data: 'specialCodeDescription', name: 'specialCodeDescription' },
      { data: 'type', name: 'type' },
    ...
    table.buttons().container().appendTo('#products_wrapper .col-md-6:eq(0)');
    });
  </script>
  <script>
    $(document).ready(function () {
