    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2 align-items-center">
                <div class="col-sm-6">
                    <h3 class="m-0">Onaylı Siparişler</h3>
                </div>
                <!-- /.col -->
                <div class="col-sm-6">
        ...
        <div class="container-fluid">
            <div class="">
                <div class="card card-secondary">
                    <div class="card-body">
                        <table id="approvedOrders" class="table table-bordered table-striped">
                            <thead>
                                <tr>
    ...
    <script>
        $(document).ready(function () {
            var table = $('#approvedOrders').DataTable({
                ...
                serverSide: true,
                responsive: true,
                ajax: "{{ route('approvedOrders.data') }}",
                dom: 'Bfrtip',
                buttons: ["excel", "pdf"],
                columns: [
            ...
            table.buttons().container().appendTo('#approvedOrders_wrapper .col-md-6:eq(0)');
        });
    </script>
    <script>
        $(document).ready(function () {
