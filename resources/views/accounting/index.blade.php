    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2 align-items-center">
                <div class="col-sm-6">
                    <h3 class="m-0">Muhasebe Birimi</h3>
                </div>
                <!-- /.col -->
                <div class="col-sm-6">
                </div>
        ...
        <div class="container-fluid">
            <div class="">
                <div class="card card-secondary">
                    <div class="card-body">
                        <table id="accounting" class="table table-bordered table-striped">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center">Muhasebe Biriminde Olan Ürün Sayısı</th>
        ...
        $(document).ready(function () {
            var table = $('#accounting').DataTable({
                ...
                columns: [
                    ...
                    { data: 'accountingProductsCount', name: 'accountingProductsCount',
            ...
            table.buttons().container().appendTo('#accounting_wrapper .col-md-6:eq(0)');
        });
    </script>
    <script>
        $(document).ready(function () {
