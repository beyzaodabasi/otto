        ...
        <div class="container-fluid">
            <div class="">
                <div class="card card-secondary">
                    <div class="card-body">
                        <table id="manufacturing" class="table table-bordered table-striped">
                            <thead>
                                <tr>
...
@section('customjs')
    ...
    <script>
        $(document).ready(function () {
            var table = $('#manufacturing').DataTable({
                processing: true,
                serverSide: true,
                responsive: true,
                ajax: "{{ route('manufacturing.data') }}",
                dom: 'Bfrtip',
                buttons: ["excel", "pdf"],
                columns: [
            ...
            table.buttons().container().appendTo('#manufacturing_wrapper .col-md-6:eq(0)');
        });
    </script>
    <script>
        $(document).ready(function () {
