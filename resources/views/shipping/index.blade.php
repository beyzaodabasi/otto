                    ...
                    <table id="shipping" class="table table-bordered table-striped">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center">Sevk/Depo Hattında Olan Ürün Sayısı</th>
    ...
    $(document).ready(function() {
        var table = $('#shipping').DataTable({
            ...
            columns: [{
                ...
                {
                    data: 'shippingProductsCount',
                    name: 'shippingProductsCount',
        ...
        table.buttons().container().appendTo('#shipping_wrapper .col-md-6:eq(0)');
    });
</script>
<script>
    $(document).ready(function() {
